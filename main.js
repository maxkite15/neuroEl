...
function createWindow () {
  ...
  if (platform == 'darwin'){
    mainWindow = new BrowserWindow({width: 1280, height: 800, icon: __dirname + '/src/public/img/icon.png'})
  }else if (platform == 'linux'){
    mainWindow = new BrowserWindow({width: 1280, height: 800, icon: __dirname + '/src/public/img/icon.png'})
  }else{
    mainWindow = new BrowserWindow({width: 1280, height: 800, icon: __dirname + '/src/public/img/icon.ico'})
  }
